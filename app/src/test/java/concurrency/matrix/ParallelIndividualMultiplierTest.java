...
/**
 * Test the running of multiply in ParallelIndividualMultiplierTask
 */
...
public class ParallelIndividualMultiplierTest {
    ...
    @DisplayName("parallel multiplier gives correct result")
    @Test
    void parallelMultiplierIsCorrect() {
    ...
    @DisplayName("parallel multiplier running time test")
    @Test // Takes appr 2500 ms
    void parallelMultiplierRunningTime() {
    ...
    @DisplayName("compare parallel and serial results")
    @Test
    void compareSerialAndParallel() {
        matrix1 = MatrixGenerator.generate(100, 200); // 100 x 200
        matrix2 = MatrixGenerator.generate(200, 500); // 200 x 500
        ...
        ParallelIndividualMultiplier.multiply(matrix1, matrix2, parallelResult);
